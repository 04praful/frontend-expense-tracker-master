...
const ExpenseForm = () => {
  ...
  useEffect(() => {
    axios
    .get(`https://hello-a7fb5-default-rtdb.firebaseio.com/expenses/${ChangesEMail}.json`)
    .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
    .post(`https://hello-a7fb5-default-rtdb.firebaseio.com/expenses/${ChangesEMail}.json`,{
      amount:enteredEmail,
  ...
  const handleDelete = (id) => {
    axios
    .delete(`https://hello-a7fb5-default-rtdb.firebaseio.com/expenses/${ChangesEMail}/${id}.json`)
    .then(() => {
